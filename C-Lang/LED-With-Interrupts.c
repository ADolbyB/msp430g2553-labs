    ...
    for (;;)
        {
            ...
            else if (counter == 3)                  // MODE #2 - Flash Red LED
                {
                    P1OUT &= ~LED1;                 // turn LED1 (GREEN) off
                    P1OUT ^= LED2;                  // toggle LED2 (RED)
                    __delay_cycles(150000);         // Flash Delay: 150,000 micro seconds
                }
            else if (counter == 4)                  // MODE #3 - Flash Green & Red Alternately
                {
            ...
            else if (counter == 5)                  // MODE #4 - Flash Green & Red Simultaneously
                {
            ...
            else if (counter == 6)                  // MODE #5 - Flash Red 2x & Green 2x Alternately
                {
                    P1OUT |= LED2;
