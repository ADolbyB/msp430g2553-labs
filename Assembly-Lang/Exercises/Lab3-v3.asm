...
LINE_A      clr.w   SR                      ; clear SR to 0000
            ...
            mov.w   #0x0104, SR             ; Set N and V bits in SR to 1
...
QUIZ3_1     mov.w   #0x5995, R5             ; copy #0x5995 to R5
...
QUIZ3_2     mov.w   @R5+, -2(R6)            ; copy &->(R5) to &->(R6 - 2)
...
LINE_C      clr.w   SR                      ; clear SR to 0000
            ...
            mov.w   #0x0200, R6             ; copy #0x0202 to R6
...
QUIZ3_3     addc.w  R5, R6                  ; add w/ carry R5 to R6
            ...
            rrc.b   &0x206                  ; Rotate Right w/ carry one byte at &0x0200
