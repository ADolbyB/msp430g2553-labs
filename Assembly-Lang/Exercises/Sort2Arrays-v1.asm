...
SORT2       mov.w   #ARY2, R4               ; Initialize R4 to point to ARY2  in the memory
            ...
            mov.b   #0x0220, R5             ; reset R5 to beginning of 3rd UNSORT array
            mov.b   #0x0230, R7             ; reset R7 to beggining of 4th SORT array
            mov.b   #10, R10                ; set array size as counter
            call    #SORT                   ; Calling Subroutine Sort with parameter passing in R4 abd R6
...
IF_LESS     mov.b   0(R7), R12              ; Store larger value to R12
            mov.b   1(R7), R11              ; Store smaller value to R11
            mov.b   R11, 0(R7)              ; Store smaller value to lower array index
            mov.b   R12, 1(R7)              ; Store larger value to higher array index
            inc     R7                      ; increment R7 to next index in SORTED array
...
SKIP        inc     R7                      ; increment index of unsorted array
            cmp.b   R9, R10                 ; check if at end of array
            jeq     OUTER_LP                ; decrement outer counter if at end of array
            inc.b   R9                      ; increment inner loop counter
...
OUTER_LP    dec.b   R10                     ; decrement R10 counter
            ...
            mov.w   #0x211, R7              ; point R7 to beginning of array again
            jmp     SORT
